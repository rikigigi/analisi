...
int main(int argc, char ** argv)
{
    ...
    options.add_options()
            ...
            ("mean-square-displacement-self,qs",boost::program_options::bool_switch(&msd_self)->default_value(false),"calcola e stampa nell'output lo spostamento quadratico medio di ciascuna specie atomica calcolato nel sistema di riferimento del rispettivo centro di massa")
